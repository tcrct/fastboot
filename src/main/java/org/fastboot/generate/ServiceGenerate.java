...
public class ServiceGenerate {
    ...
    private String builderImport() {
        ...
        importStr.append("import ").append(basePackage).append(".dao.").append(fileName).append("Dao;").append("\n");
        importStr.append("import ").append(basePackage).append(".cache.").append(fileName).append("CacheService;").append("\n");
    ...
    private String builderBody() {
        ...
        bodyStr.append("\tprivate ").append(fileName).append("CacheService ").append(fileName.toLowerCase()).append("CacheService;").append("\n");
        bodyStr.append("\t@Autowired").append("\n");
        bodyStr.append("\tprivate ").append(fileName).append("Dao ").append(fileName.toLowerCase()).append("Dao;").append("\n");
        bodyStr.append("\n");
